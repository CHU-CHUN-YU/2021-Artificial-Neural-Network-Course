...
x_train=open("D:/hw2_data/pm25/PM25/train_X.txt")
...
checkpoint =ModelCheckpoint("D:/important/TA/ANN/109學期\hw2/hw2_data/pm25/PM25/bp-model.hdf5",save_best_only=True) #設定儲存路徑
...
model=load_model("D:/hw2/hw2_data/pm25/PM25/bp-model.hdf5") #把儲存好的最佳模式讀入
batch_size=8
